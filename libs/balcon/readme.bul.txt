Balabolka (конзолно приложение), версия 1.45
Авторски права (c) 2013-2018 Илия Морозов
...
balcon -f d:\book.txt -n Irina -o --ignorelength | oggenc2 --ignorelength - -o d:\book.ogg


Пример за използване в комбинация с WMAENCODE.EXE:

balcon -f d:\book.txt -n Irina -o --ignorelength | wmaencode - d:\book.wma --ignorelength
