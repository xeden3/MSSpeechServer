Балаболка (консольное приложение), версия 1.45
Copyright (с) 2013-2018 Илья Морозов
Все права защищены
...
balcon -f d:\book.txt -n Alyona -o --ignorelength | oggenc2 --ignorelength - -o d:\book.ogg


Пример использования приложения совместно с утилитой WMAENCODE.EXE:

balcon -f d:\book.txt -n Alyona -o --ignorelength | wmaencode - d:\book.wma --ignorelength
